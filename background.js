/***
 * Developed by: Mitanshu Kumar. Twitter:mitanshukr
 * Design and Inspiration: Javascript30.com (Wes Bos)
 * Extension logo by: www.flaticon.com (All rights reserved.)
 * 
 * Feel Free to Fork or improve or suggest any change. Please give credits to original Owners.
 * Thank you for being here.
 ***/
console.info(`Thank you for downloading Timer Alarm extension.`);
console.info(`Please rate the app and share you feedback and reviews on twitter with @mitanshukr.`);
